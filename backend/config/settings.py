...
FREE_MAX_UPLOAD_SIZE_MB = int(os.getenv('FREE_MAX_UPLOAD_SIZE_MB', 50))
PRO_MAX_UPLOAD_SIZE_MB = int(os.getenv('PRO_MAX_UPLOAD_SIZE_MB', 250))
BUSINESS_MAX_UPLOAD_SIZE_MB = int(os.getenv('BUSINESS_MAX_UPLOAD_SIZE_MB', 1000))

FREE_MAX_DURATION_SECONDS = int(os.getenv('FREE_MAX_DURATION_SECONDS', 1800))  # 30 min
PRO_MAX_DURATION_SECONDS = int(os.getenv('PRO_MAX_DURATION_SECONDS', 18000))    # 300 min
BUSINESS_MAX_DURATION_SECONDS = int(os.getenv('BUSINESS_MAX_DURATION_SECONDS', 72000))  # 1200 min
